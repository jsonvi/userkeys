...
function frontController(evt) {
    ...
    if (target.__proto__ === HTMLInputElement.prototype || target.__proto__ === HTMLTextAreaElement.prototype) {
            ...
            showHelp: function() {
                ...
                if (allKeys.length > 0) {
                    ...
                    jQuery.each(allKeys, function(keyIndex, keyValue) {
                        ...
                        var keyHtml = "<li><span>" + keyValue.keyChar + "</span> " + keyDesc + keyName + "</li>";
                        allKeysHtml += keyHtml;
                    });
                    allKeysHtml += "</ul>";
